// ============================================================================
// <copyright file="MultiDimensialFuzzyCMeans.cs" company="DevRain">
...
namespace DevRain.Data.Mining
{
    ...
    public sealed class MultiDimensialFuzzyCMeans
    {
        ...
        /// </summary>
        private List<ClusterPointND> Points;

        /// <summary>
        /// Array containing all clusters handled by the algorithm
        /// </summary>
        private List<ClusterPointND> Clusters;
        ...
        public MultiDimensialFuzzyCMeans(List<ClusterPointND> points, List<ClusterPointND> clusters)
            : this(points, clusters, 2.0)
        {
        ...
        public MultiDimensialFuzzyCMeans(List<ClusterPointND> points, List<ClusterPointND> clusters, double fuzzy)
        {
            if (points == null)
            {
        ...
        /// Private constructor
        /// </summary>
        private MultiDimensialFuzzyCMeans()
        {
        }
        ...
        private double CalculateEulerDistance(ClusterPointND point, ClusterPointND centroid)
        {
